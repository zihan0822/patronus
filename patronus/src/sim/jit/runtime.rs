...
mod trampoline {
    ...
    pub(super) enum BVOpKind {
        ...
        Cmp(unsafe extern "C" fn(*const BitVecValue, *const BitVecValue) -> i64),
        Slice(unsafe extern "C" fn(*const BitVecValue, WidthInt, WidthInt) -> *mut BitVecValue),
        Concat(unsafe extern "C" fn(i64, i64, WidthInt, WidthInt) -> *mut BitVecValue),
        Extend(unsafe extern "C" fn(i64, WidthInt, WidthInt) -> *mut BitVecValue),
        Shift(unsafe extern "C" fn(*const BitVecValue, i64, WidthInt) -> *mut BitVecValue),
    }
    ...
    pub(super) unsafe extern "C" fn __bv_slice(
        ...
        Box::leak(Box::new((*value).slice(hi, lo)))
    }
